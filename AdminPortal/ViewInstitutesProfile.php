                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-10 mt-3">
                            <h1 class="m-0 demo text-dark"><u><b>Institute Profile</b></u></h1>
                        </div><!-- /.col -->
            ...
            <div class="content">
                <div class="container-fluid">
                    <form action="instituteregistrationsubmit.php" id="instituteform">
                        <?php 
                            $sql="SELECT * FROM instituteregistrationform WHERE `Id` = ".$_GET['id'];
                        ...
                        <div class="row">
                            ...
                            <?php 
                                 $count = 1;
                                $sql="SELECT * FROM instituteregistrationjobs WHERE `Instituteregform_Id` = ".$_GET['id'];
                                $result = mysqli_query($conn,$sql);
                                    ...
                                    <div class="col-sm-3">
                                        <hr>
                                         <div class="form-group job">
                                             <p style="font-weight: bold">Job '.$count++.'</p>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <hr>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value='.$row1['Class'].'
                                                style="outline: none; margin-top: -12px;">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value='.$row1['Subjects'].'
                                                style=" outline: none; margin-top: -12px;">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
