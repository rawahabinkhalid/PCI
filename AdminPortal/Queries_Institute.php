...
<head>
    ...
    <title>Admin Panel | Institute Queries</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-9">
                            <h1 class="m-0 demo text-bold">Institute-Queries</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-3">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#" style="color:#007bff">Home</a></li>
                                <li class="breadcrumb-item active">Institute Queries</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    <div class="row mt-5">
                        <?php
                            ...
                            $sql = "SELECT * FROM queryinstitute ORDER BY Id DESC";
