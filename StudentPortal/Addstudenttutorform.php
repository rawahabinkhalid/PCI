                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6 mt-3">
                            <h1 class="m-0 text-dark"><u>Add Child/Siblings/Student Tuition Form</u></h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6 mt-3">
            ...
            <div class="content">
                <div class="container-fluid">
                    <form action="studenttutorformsubmit.php" id="addstudent">
                        <?php
                            $sql = "SELECT * FROM studenttutorform WHERE `UserId` = ".$_SESSION['userid'];
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="fathername" type="text" required readonly
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="email" type="email" required readonly
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="contactno1" type="text" required readonly
                                        pattern="^\(?([0-9]{4})\)?([-])([0-9]{7})$"
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="contactno2" type="text" readonly
                                        pattern="^\(?([0-9]{4})\)?([-])([0-9]{7})$"
                                        title="Phone # should be in format 0123-4567890"
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="contactno3" type="text" readonly
                                        pattern="^\(?([0-9]{4})\)?([-])([0-9]{7})$"
                                        title="Phone # should be in format 0123-4567890"
                                    ...
                                    <div class="row" style="padding: 0px 5px;">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="housenum" type="text" required
                                                    readonly value="<?php echo $row['HouseNumber'];?>"
                                                    style="outline: none; margin-top: -12px;">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="buildingname" type="text" readonly
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="streetnum" type="text" readonly
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="blocknum" type="text" readonly
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="area" required readonly
                                                    style="outline: none; margin-top: -12px;">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="city" type="text" required readonly
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="country" type="text" required readonly
