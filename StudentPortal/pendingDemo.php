                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-lg-4 offset-lg-1">
                                                    ...
                                                    <br>
                                                    <button type="button" name="" class="btn btn-success scheduledDemoStudentTeacher" data-toggle="modal" data-id="Teacher" style="width:250px" value="'.$row['Id'].'" data-target="#myModal1" 
