...
<head>
    ...
    <title>Student Panel | Demo Confirmed History</title>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6 mt-3">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Demo Confirmed History</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                    ...
                    <table class="table table-bordered" id="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col"><b>Confirmed Date</b></th>
                            </tr>
                        </thead>
                        <tbody id="tbody_table">
                            <?php
                                // $count = 1;
                                // $sql = 'SELECT requestdemo_studentside.*, StudentName, FullName FROM requestdemo_studentside JOIN studenttutorform ON requestdemo_studentside.Student_Id = studenttutorform.Id JOIN tutorform_section1 ON tutorform_section1.Id = requestdemo_studentside.TeacherId WHERE requestdemo_studentside.Status = "Confirmed" ';
                                // // echo $sql;
