                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-lg-4 offset-lg-1">
                                                    ...
                                                    <br>
                                                    <button type="button" name="" class="btn btn-success scheduledDemoStudentTeacher" style="width:250px" data-toggle="modal" data-target="#myModal1" data-id="Teacher" value="'.$row['Id'].'">Confirm</button>
                                                    <br><br>
                                                    <button class="btn btn-danger RejectButtonStudent"  value="'.$row['Id'].'" type="button" data-toggle="modal" data-id="Teacher" data-target="#myModal2" style="width:250px">Reject</button>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
...
function runAjax(obj) {
    $.ajax({
        type: "POST",
        url: "ScheduledByStudent.php",
        cache: false,
        data: JSON.stringify(obj),
        contentType: "json",
        success: function(data) {
            console.log(data);
            window.open('pendingDemo.php', '_self');
