                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-10 mt-3">
                            <h1 class="m-0 demo text-dark"><u><b>My Profile</b></u></h1>
                        </div><!-- /.col -->
            ...
            <div class="content">
                <div class="container-fluid">
                    <form action="tutorformsubmit.php" id="tutorform" enctype="multipart/form-data">
                        <!-- section 1 -->
                        <?php
                            $sql = "SELECT * FROM tutorform_section1 WHERE `TeacherId` =".$_SESSION['userid'] . " ORDER BY Id DESC";
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class=" form-group">
                                    <p style="font-weight: bold">Total Experience</p>
                                    <input class="form-control" value="<?php echo $row['TotalExperience'] ?>"
                                        style="outline: none; margin-top: -12px;">
                                </div>
                            </div>
                            ...
                            <?php
                            $sql = "SELECT * FROM tutorform_section2 WHERE `UserId` =".$_SESSION['userid'];
                            $result= mysqli_query($conn,$sql);
                            ...
                            <?php
                            $sql = "SELECT * FROM tutorform_section3 WHERE `UserId` =".$_SESSION['userid'];
                            $result= mysqli_query($conn,$sql);
                            while($row = mysqli_fetch_assoc($result)){
                                echo '
                                  <div class="col-sm-4">
                            ...
                            <!-- section 5 -->
                            <?php
                            $sql = "SELECT * FROM tutorform_section5 WHERE `UserId` =".$_SESSION['userid'] . ' LIMIT 2';
                            ...
                            <?php
                            $sql = "SELECT * FROM tutorform_section1 WHERE `Id` =".$_SESSION['userid'];
                            $result= mysqli_query($conn,$sql);
                            $row = mysqli_fetch_assoc($result);
                            ?>
                            <div class="col-sm-4">
                        ...
                        <div class="row">
                            <div class="col-sm-2 text-center">
                                ...
                                <?php 
                            $sql = 'SELECT COUNT(Status) FROM requestdemo_teacherside WHERE `Status` = "Pending" AND `TeacherId` = "'.$_SESSION['userid'].'" ';
                            $result = mysqli_query($conn, $sql);
                            while($row = mysqli_fetch_assoc($result)){
                            ...
                            <div class="col-sm-2 text-center">
                                ...
                                <?php 
                            $sql = 'SELECT COUNT(Status) AS Count_Status FROM requestdemo_teacherside WHERE `Status` = "Scheduled" AND `TeacherId` = "'.$_SESSION['userid'].'" ';
                            $result = mysqli_query($conn, $sql);
                            while($row = mysqli_fetch_assoc($result)){
                            ...
                            <div class="col-sm-2 text-center">
                                ...
                                <?php 
                            $sql = 'SELECT COUNT(demostatus.Status) FROM requestdemo_teacherside LEFT JOIN demostatus ON requestdemo_teacherside.Id = demostatus.DemoId WHERE demostatus.`Status` = "Confirmed" AND `TeacherId` = "'.$_SESSION['userid'].'" ';
                            $result = mysqli_query($conn, $sql);
                            while($row = mysqli_fetch_assoc($result)){
                            ...
                            <div class="col-sm-3 text-center">
                                ...
                                <?php 
                            $sql = 'SELECT COUNT(*) AS Count_Status FROM requestdemo_teacherside LEFT JOIN demostatus ON requestdemo_teacherside.Id = demostatus.DemoId WHERE (demostatus.`Status` = "Rejected" OR (demostatus.`Status` IS NULL AND requestdemo_teacherside.`Status` = "Rejected")) AND `TeacherId` = "'.$_SESSION['userid'].'" ';
                            $result = mysqli_query($conn, $sql);
                            while($row = mysqli_fetch_assoc($result)){
                                echo '<p>' .$row['Count_Status']. '</p>';
                            }
                        ...
                        echo "No Teacher Profile Careated";
                        }
                        ?>
                    </form>
                </div>
