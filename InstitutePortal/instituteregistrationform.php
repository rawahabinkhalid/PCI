                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6 mt-3">
                            <h1 class="m-0 text-dark"><u>Institute Registration Form</u></h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6 mt-3">
            ...
            <div class="content">
                <div class="container-fluid">
                    <form action="instituteregistrationsubmit.php" id="instituteform">
                        <?php 
                            $sql="SELECT * FROM instituteregistrationform WHERE `UserId` = ".$_SESSION['userid'] . " AND FormStatus = 'Draft'";
                            ...
                            <div class="col-sm-12 mt-3">
                                <div style="height: auto; border:1px solid #000; background-color:#ebf8a4;
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <p class="text-danger"><b>To add another Job to your account you must
                                                    complete and
                                                    submit this form
                                                    first and select add Job option in the sidebar to add another
                                                    Institute Job.
                                                </b>
                                            </p>
                                        </div>
