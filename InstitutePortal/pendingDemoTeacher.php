                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <table class="table table-bordered text-center">
                                ...
                                $sql = 'SELECT requestdemo_instituteside.Id, tutorform_section1.TutorImage, tutorform_section1.FullName, tutorform_section1.PhoneNo1, tutorform_section1.Email, instituteregistrationform.InstituteName, instituteregistrationform.ContactNo1, instituteregistrationform.Email AS Ins_Email , ScheduledDateByAdmin FROM requestdemo_instituteside JOIN instituteregistrationform ON requestdemo_instituteside.Institute_Id = instituteregistrationform.Id JOIN tutorform_section1 ON tutorform_section1.Id = requestdemo_instituteside.TeacherId WHERE requestdemo_instituteside.`Status` = "Scheduled" AND requestdemo_instituteside.`StatusByInstitute` = ""';
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-lg-4 offset-lg-1">
                                                    ...
                                                    <br>
                                                    <button type="button" name="" class="btn btn-success scheduledDemoInstituteTeacher" style="width:250px" value="'.$row['Id'].'">Confirm</button>
                                                    <br><br>
