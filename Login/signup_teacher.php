        ...
        <div class="d-flex justify-content-center h-100">
            <div class="card">
                <div class="card-header text-center">
                    <img src="images/teacher.png" class="center" style="width:70px;">
                    <h3><u>Teacher Sign Up</u></h3>
                ...
                <div class="card-body">
                    <form action="signup_teacher_data.php" id="signupteacher">
...
<script>
$("#signupteacher").submit(function(e) {
