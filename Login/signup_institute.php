...
<head>
    <title>Institute SignUp Page</title>
        ...
        <div class="d-flex justify-content-center h-100">
            <div class="card">
                <div class="card-header text-center">
                    <img src="images/admin.png" class="center" style="width:70px;">
                    <h3><u>Institute Sign Up</u></h3>
                ...
                <div class="card-body">
                    <form action="signup_institute_data.php" id="signupinstitute">
...
<!-- *************************** api signup Institute form ************************* -->
<script>
$("#signupinstitute").submit(function(e) {
